...
model =  DecisionTreeClassifier(random_state = 0, max_features='auto', max_depth=200)
...
#tree_to_code(tree=rfecv.estimator_, feature_names=['Fare', 'Sex_male'])
# new_tree,pic = get_tree_pic(df_X=X_train, df_Y=Y_train, var=['Fare', 'Sex_male'])
# pic
