...
pipeline = make_pipeline(
    ...
    #,RFE(estimator=SVR(kernel="linear"), n_features_to_select=0.5, step=1)
...
X_train_trans=pipeline.fit_transform(X_train.copy(),Y_train.copy())

# best_model_2=pre_eval_models(
#     type_model='regression',
#     independent=X_train_trans, 
#     dependent=Y_train,
#     scoring='neg_root_mean_squared_error',
#     cv=10)
...
sorted(best_model,key=lambda x: x[1],reverse=True)
...
# w SelectPercentile 10 w StandardScaler + new var add          Negative RMSLE -0.14163059452071128 public: 0.14721
    #{'objective': 'reg:squarederror', 'n_estimators': 1000, 'max_depth': 3, 'learning_rate': 0.1, 'booster': 'dart'} -32464.857048511272
# w SelectPercentile 10 w StandardScaler + new var add       Negative RMSLE -0.12896539924234887 public: 0.14707
    #{'objective': 'reg:squarederror', 'n_estimators': 200, 'max_depth': 7, 'learning_rate': 0.25, 'booster': 'dart'} -31304.72710784186
# w RFE 10 w StandardScaler + new var add                    Negative RMSLE -0.12791113815551172 public: 0.12876
# w SelectFromModel 10 w StandardScaler + new var add        Negative RMSLE -0.13323730275456336            
    #{'objective': 'reg:squaredlogerror', 'n_estimators': 2000, 'max_depth': 7, 'learning_rate': 0.2, 'booster': 'gbtree'} -198488.69012583172
# SequentialFeatureSelector runs very long
# w RFECV 10 w StandardScaler + new var add                  Negative RMSLE -0.13308749003269715 public: 0.12856
