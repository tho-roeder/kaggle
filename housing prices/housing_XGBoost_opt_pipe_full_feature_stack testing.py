...
pipeline = make_pipeline(
    ...
    #,(CatBoostRegressor())
    # ,(XGBRegressor())
    # ,StackingRegressor(regressors=(GradientBoostingRegressor(),ExtraTreesRegressor(),XGBRegressor(),LGBMRegressor())
    #                    , meta_regressor=CatBoostRegressor())
    ,stack(estimators=estimators, final_estimator=CatBoostRegressor()
...
#         # ,'xgbregressor__n_estimators': [100,200,500,1000,2000,2500,5000]
...
#         'rfe__n_features_to_select': [0.3,0.5,0.6,0.7,0.9]
#         ,'rfe__step':[1,3]
...
trans_model =RandomizedSearchCV(pipeline
                          ...
                          ,cv = 2
                          ,n_jobs=-1)
trans_model.fit(X_train.copy(), Y_train.copy())
...
# R2 Square 0.9153192036948998
# Negative RMSLE -0.12425910229719266

#added Regressors
# R2 Square 0.9145732630545486
# Negative RMSLE -0.12518914314459054
...
df_test['SalePrice']=trans_model.predict(df_test.copy())
